const en = {
  ...
  servers: {
    ...
    internet: {
      ...
      public: 'Internet', publicHint: 'For players anywhere.', closed: 'Closed', opening: 'Opening the port…', whenStarts: 'Opens when the server starts.',
      open: 'Open to the internet', close: 'Close access', failed: 'Not reachable',
      manual: 'Forward TCP port {port} to {ip} in your router, or use a tunnel like playit.gg.',
