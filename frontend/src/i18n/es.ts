...
const es: Dict = {
  ...
  servers: {
    ...
    internet: {
      ...
      public: 'Internet', publicHint: 'Para jugadores en cualquier lugar.', closed: 'Cerrado', opening: 'Abriendo el puerto…', whenStarts: 'Se abre cuando el servidor inicie.',
      open: 'Abrir a internet', close: 'Cerrar acceso', failed: 'Sin acceso',
      manual: 'Redirige el puerto TCP {port} a {ip} en tu router, o usa un túnel como playit.gg.',
