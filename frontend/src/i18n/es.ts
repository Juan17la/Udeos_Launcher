...
const es: Dict = {
  ...
  nav: {
    dashboard: 'Instancias', servers: 'Servidores', skins: 'Skins', search: 'Complementos', newInstance: 'Nueva instancia', privacy: 'Privacidad y términos',
  ...
  servers: {
    ...
    internet: {
      ...
      needsUdeos: 'También necesitan Udeos Launcher: solo entran jugadores de Udeos, así se ven las skins (Ajustes → Quién puede entrar).',
    ...
    settings: {
      ...
      login: 'Quién puede entrar', logins: { udeos: 'Solo Udeos', offline: 'Cualquiera', microsoft: 'Solo Microsoft' },
      loginHints: {
        udeos: 'Se ven las skins. Se entra con Udeos Launcher; otros launchers reciben "Invalid session".',
        offline: 'Puede entrar gente de cualquier launcher. No se ve ninguna skin.',
        microsoft: 'Solo jugadores con cuenta de Microsoft. Los jugadores de Udeos no pueden entrar.',
      },
  ...
  skins: {
    title: 'Skins', subtitle: 'Elige tu aspecto en todas tus instancias.',
    new: 'Nueva skin', wearing: 'Llevas', default: 'Por defecto',
    where: 'En un jugador y en tus servidores',
    library: 'Biblioteca', drop: 'Suelta una skin descargada', dropHint: 'Cualquier .png de una web de skins', browse: 'Buscar archivos',
    use: 'Clic para llevarla', inUse: 'En uso', edit: 'Editar',
    models: { classic: 'Clásico', slim: 'Delgado' }, modelHints: { classic: 'Brazos de 4 píxeles, como Steve.', slim: 'Brazos de 3 píxeles, como Alex.' },
    remove: 'Eliminar skin', confirmDeleteTitle: '¿Eliminar esta skin?', confirmDelete: '"{name}" se quitará de la biblioteca.', confirmDeleteWorn: ' Los perfiles que la llevan vuelven a la skin por defecto.',
    add: { title: 'Añadir skin', name: 'Nombre', model: 'Modelo', detected: 'Sus brazos parecen {model}: cámbialo si la vista previa se ve mal.', wear: 'Ponérmela ya', submit: 'Añadir skin' },
    dragToTurn: 'Arrastra para girar',
    editor: {
      newTitle: 'Nueva skin', editTitle: 'Editar {name}', subtitle: 'Pinta sobre la skin plana o directamente sobre el modelo.',
      tools: { pencil: 'Lápiz (B)', eraser: 'Borrador (E)', fill: 'Rellenar (G)', picker: 'Tomar un color (I)' },
      undo: 'Deshacer (Ctrl+Z)', redo: 'Rehacer (Ctrl+Y)', color: 'Color', recent: 'Colores recientes',
      layer: 'Capa', layers: { base: 'Base', overlay: 'Segunda capa' }, layerHint: 'La segunda capa va encima: gorros, chaquetas, mangas. Lo transparente deja ver la base.',
      name: 'Nombre', namePlaceholder: 'p. ej. Caballero', model: 'Modelo', save: 'Guardar skin', flat: 'Skin plana', model3d: 'Sobre el modelo',
      hint3d: 'Haz clic en el modelo para pintar · arrastra a su lado o con el botón derecho para girar',
      parts: { head: 'Cabeza', body: 'Cuerpo', rightArm: 'Brazo derecho', leftArm: 'Brazo izquierdo', rightLeg: 'Pierna derecha', leftLeg: 'Pierna izquierda' },
      faces: { top: 'arriba', bottom: 'abajo', right: 'lado derecho', front: 'frente', left: 'lado izquierdo', back: 'espalda' },
      unused: 'El juego no lo usa', restored: 'Tus cambios sin guardar han vuelto.', discard: 'Empezar de nuevo',
      discardTitle: '¿Descartar tus cambios?', discardBody: 'Se perderá lo que pintaste desde la última vez que guardaste.', discardConfirm: 'Descartar',
    },
  },
  search: {
