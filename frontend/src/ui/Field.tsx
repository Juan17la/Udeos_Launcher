...
/** Checkbox: green when checked, the light Minecraft gray when not. The
 *  native input is kept (keyboard, forms) and visually replaced through
 *  Tailwind's peer variants. The box is 28px so the universal 15px radius
 *  still reads as a rounded square rather than a circle. */
